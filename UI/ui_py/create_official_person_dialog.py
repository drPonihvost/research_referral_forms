...
class Ui_create_official_person_dialog(object):
    def setupUi(self, create_official_person_dialog):
        ...
        create_official_person_dialog.resize(392, 512)
        font = QFont()
        ...
        self.label_6 = QLabel(self.create_official_person_widget)
        self.label_6.setObjectName(u"label_6")

        self.formLayout.setWidget(0, QFormLayout.LabelRole, self.label_6)

        self.surname_le = QLineEdit(self.create_official_person_widget)
        self.surname_le.setObjectName(u"surname_le")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.surname_le)

        self.label_5 = QLabel(self.create_official_person_widget)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.name_le)
        ...
        self.middle_name_le = QLineEdit(self.create_official_person_widget)
        self.middle_name_le.setObjectName(u"middle_name_le")

        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.middle_name_le)
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.department_te)
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.post_te)
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.rank_le)
        ...
        QWidget.setTabOrder(self.rank_le, self.accept_pb)
    ...
    def retranslateUi(self, create_official_person_dialog):
        ...
        self.label_6.setText(QCoreApplication.translate("create_official_person_dialog", u"\u0424\u0430\u043c\u0438\u043b\u0438\u044f:", None))
        self.label_5.setText(QCoreApplication.translate("create_official_person_dialog", u"\u0418\u043c\u044f:", None))
        self.label_4.setText(QCoreApplication.translate("create_official_person_dialog", u"\u041e\u0442\u0447\u0435\u0441\u0442\u0432\u043e:", None))
