...
from UI.interface.base_widgets import BaseForm, LineEditWithTip
from UI.interface.division_form import DivisionForm
from UI.interface.error_widget import ErrorWidget
from data_base.models import Division
...
if __name__ == "__main__":
    ...
    w = OfficialPersonForm(person='addressee')
    w.show()
    sys.exit(app.exec())
